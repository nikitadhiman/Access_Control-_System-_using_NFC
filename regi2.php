...
{
var name =img.src;
window.location.href = "regi2_2.php?var2=" + name;
}
</script>
...
if(isset($_SESSION['registration']))
{
	...
	if ($_SESSION['registration']=='one')
	{
			echo '<center><h4>Image Layer 2/3<br><font color="orange">Complete all the layers to complete your registration !</font><br><br>
