...
{
var name = img.src;
window.location.href = "login2_2.php?var2=" + name;
}
</script>
...
if(isset($_SESSION['login']))
{
	...
	if ($_SESSION['login']=='one')
	{

		echo '<center><h4>Image Layer 2/3<br><i>Selecting any image will redirect you the next layer !<br><br>
