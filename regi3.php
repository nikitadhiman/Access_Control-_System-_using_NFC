...
{
var name =img.src;
window.location.href = "success_regi.php?var3=" + name;
}
</script>>
<title>
Layer 3!
...
if(isset($_SESSION['registration']))
{
	...
	if ($_SESSION['registration']=='two')
	{
			echo '<center><h4>Image Layer 3/3<br><font color="orange">Select to complete your registration !</font><br><br>
